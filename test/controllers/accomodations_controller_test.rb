...
class AccomodationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accomodation" do
    assert_difference('Accomodation.count') do
      post accomodations_url, params: { accomodation: { body: @accomodation.body, city: @accomodation.city, title: @accomodation.title } }
    end
  ...
  test "should update accomodation" do
    patch accomodation_url(@accomodation), params: { accomodation: { body: @accomodation.body, city: @accomodation.city, title: @accomodation.title } }
